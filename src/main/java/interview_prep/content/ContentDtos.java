...
public class ContentDtos {
    ...
    public record TestSummary(Long id, String title, String description, int questionCount) {
    }

    public record TestResponse(Long id, Long professionId, String title, String description, List<QuestionResponse> questions) {
    }
